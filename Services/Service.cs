...

{
    public class Service
    {
        ...
        {
            User[] users = new User[] {
                new User{ Id = 1, Name = "Ram", Email = "ram.rana@gmail.com", Address = "Mumbai"},
                new User{ Id = 2, Name = "Arjun", Email = "arjun.chandarana@gmail.com", Address = "Ahmedabad"},
                new User{ Id = 3, Name = "Shyam", Email = "shyam.patel@gmail.com", Address = "Jamnagar"},
            };
